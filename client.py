...
client = Client("127.0.0.1", 8181, 100)
client.put("test_float_value",42, 1503319345)
client.put("test_timestamp", 0.0, 1503319740)
client.put("test_timestamp", 100.99, 1503319740)

client.get("test_float_value")
client.get("*")